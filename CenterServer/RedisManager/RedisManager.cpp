...
void RedisManager::init(const uint16_t RedisThreadCnt_) {
    ...
    // CHANNEL
    packetIDTable[(uint16_t)CHANNEL_ID::IM_CHANNEL_REQUEST] = &RedisManager::ImChannelRequest;
    packetIDTable[(uint16_t)CHANNEL_ID::USER_DISCONNECT_REQUEST] = &RedisManager::ChannelDisConnect;

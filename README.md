...
### ㅇGateway Server (MySQL, Redis Cluster) - User Authentication & Connection Game Server For Syncronization
...
- #### Move Channel
![Move Channel drawio](https://github.com/user-attachments/assets/1099b9eb-6561-4860-8365-b6ebaac191c9)
